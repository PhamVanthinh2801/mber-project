...
@Component({
  selector: 'app-van-thu-nhap-moi',
  templateUrl: './van-thu-nhap-moi.component.html',
  styleUrls: ['./van-thu-nhap-moi.component.scss']
})
export class VanThuNhapMoiComponent extends iComponentBase implements OnInit{
